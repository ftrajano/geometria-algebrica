...
- [Livro: *Ideals, Varieties, and Algorithms* — Cox, Little & O'Shea (CLO), 4ª ed. (2015)](https://link.springer.com/book/10.1007/978-3-031-91841-4) · **PDF na biblioteca**
  ...
  - **Cap. 2** — Gröbner Bases: §2 ordens monomiais (p.54), §3 algoritmo da divisão (p.61), §5 Teorema da Base de Hilbert (p.76), §7 algoritmo de Buchberger (p.90). **← motor computacional; espinha do arco atual a partir da Lição 0008.**
  - **Cap. 3** — Elimination Theory: §1 Teoremas da Eliminação e da Extensão, §2 geometria da eliminação, §3 **implicitização** (paramétrico → implícito), §4 pontos singulares e envelopes, resultantes. **O "troco" das bases de Gröbner** — a grande aplicação do Cap. 2. Depende do Cap. 2, mas o Cap. 4 não depende dele (por isso ficou fora do caminho crítico inicial até o Nullstellensatz). Fazer logo após firmar Gröbner. *(páginas exatas: puxar do PDF na biblioteca quando formos usar.)*
  ...
  > **Nota de rota (2026-06-27).** Espinha reorientada: as Lições 0001–0007 firmaram o dicionário I/V, o radical e o Nullstellensatz fraco (o "porquê"). A partir da Lição 0008 o foco vira o Cap. 2 (Gröbner, o "como" computacional) e depois o Cap. 3 (eliminação/implicitização) — devolvendo a concretude que motiva o estudo. O Nullstellensatz forte (truque de Rabinowitsch) volta quando fecharmos o laço, já com o cálculo na mão.
